...
# Добавляем константу для ссылки на поддержку
SUPPORT_BOT_URL = "https://t.me/helpgatevpn"
...
async def get_start_keyboard() -> InlineKeyboardMarkup:
    ...
    base_buttons = [
        ...
        InlineKeyboardButton(text="📞 Техподдержка", url=SUPPORT_BOT_URL),  # Заменено на ссылку
    ]
    ...
    builder.row(InlineKeyboardButton(text="📢 Новости GateVPN", url="https://t.me/vpnhelperfoyou"))
...
def get_lk_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons = [
        ...
        InlineKeyboardButton(text="💬 Помощь", url=SUPPORT_BOT_URL),  # Заменено на ссылку
